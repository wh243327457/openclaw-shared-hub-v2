...
- 生成时间: `2026-08-01T06:00:08+08:00`
- 共享根目录: `/home/vany/agent/shared`
- runtime 位置提示: `/home/vany/agent/shared/runtime`
- facts 文件数: 26
- projects 文件数: 11
- 最近 daily 文件:
  - `inbox/hermes/daily/2026-07-31.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-07-31-github-learning.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-07-30.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-07-30-tutorial-learning.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-07-30-github-learning.md` (inbox/hermes/daily)
- inbox 各 agent 文件计数:
  - `future-agent`: 0
  - `hermes`: 91
  - `openclaw`: 79
