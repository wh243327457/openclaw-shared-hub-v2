...
- 生成时间: `2026-06-24T06:00:00+08:00`
- 共享根目录: `/home/vany/agent/shared`
- runtime 位置提示: `/home/vany/agent/shared/runtime`
- facts 文件数: 26
- projects 文件数: 11
- 最近 daily 文件:
  - `inbox/hermes/daily/2026-06-23.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-06-18-tutorial-learning.md` (inbox/hermes/daily)
  - `inbox/openclaw/daily/2026-06-18.md` (inbox/openclaw/daily)
  - `inbox/hermes/daily/2026-06-17.md` (inbox/hermes/daily)
  - `inbox/openclaw/daily/2026-06-17.md` (inbox/openclaw/daily)
- inbox 各 agent 文件计数:
  - `future-agent`: 0
  - `hermes`: 55
  - `openclaw`: 75
