...
- 生成时间: `2026-08-16T06:00:05+08:00`
- 共享根目录: `/home/vany/agent/shared`
- runtime 位置提示: `/home/vany/agent/shared/runtime`
- facts 文件数: 26
- projects 文件数: 11
- 最近 daily 文件:
  - `inbox/hermes/daily/2026-08-15.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-08-15-github-learning.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-08-14.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-08-14-tutorial-learning.md` (inbox/hermes/daily)
  - `inbox/hermes/daily/2026-08-14-github-learning.md` (inbox/hermes/daily)
- inbox 各 agent 文件计数:
  - `future-agent`: 0
  - `hermes`: 114
  - `openclaw`: 79
