...
- 生成时间: `2026-06-08T06:00:02+08:00`
- 共享根目录: `/home/vany/agent/shared`
- runtime 位置提示: `/home/vany/agent/shared/runtime`
- facts 文件数: 22
- projects 文件数: 7
- 最近 daily 文件:
  - `inbox/openclaw/daily/daily/2026-06-07.md` (inbox/openclaw/daily)
  - `inbox/openclaw/daily/2026-06-07.md` (inbox/openclaw/daily)
  - `inbox/openclaw/daily/2026-06-06.md` (inbox/openclaw/daily)
  - `inbox/openclaw/daily/2026-06-06-reading-3.md` (inbox/openclaw/daily)
  - `inbox/openclaw/daily/2026-06-06-reading-2.md` (inbox/openclaw/daily)
- inbox 各 agent 文件计数:
  - `future-agent`: 0
  - `hermes`: 42
  - `openclaw`: 64
